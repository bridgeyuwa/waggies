...
final class ServicesController extends Controller
{
    public function index(): View
    {
        ...
        return view('pages.services.index', $metadata + [
            'navSection' => 'services',
            'hero' => ['imageSrc' => 'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=1200&h=600&fit=crop&q=80', 'imageAlt' => 'Stock photo of dog outdoors (client photo required)', 'eyebrow' => 'Everything Your Pet Needs', 'title' => 'Pet Care Services,<br/>All Under One Roof', 'subtitle' => 'From overnight boarding to international relocation - Waggies handles it all from one facility.', 'cta' => ['label' => 'View Our Services', 'href' => route('services.index').'#services']],
            'cards' => [
