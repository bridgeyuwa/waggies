...
final class LegalController extends Controller
{
    ...
    public function terms(): View
    {
        return $this->page('Terms of Service', 'terms-of-service', [
            ...
            ['heading' => '1. Services', 'paragraph' => 'Waggies provides pet boarding, grooming, veterinary care, training, transport, and relocation services. All services are subject to availability and must be booked in advance unless otherwise stated.'],
            ['heading' => '2. Bookings & Payments', 'paragraph' => 'All bookings are confirmed upon receipt of the required deposit. Full payment is due at check-in or as otherwise agreed. We reserve the right to cancel unconfirmed bookings.'],
            ['heading' => '3. Cancellations', 'paragraph' => 'Cancellations made more than 48 hours before the scheduled service date will receive a full refund of any deposit. Cancellations within 48 hours may forfeit the deposit at our discretion.'],
