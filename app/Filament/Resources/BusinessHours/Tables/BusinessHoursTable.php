    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('day_of_week')->label('Day')->formatStateUsing(fn (?int $state): string => ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'][$state ?? 0] ?? ''),
                TextColumn::make('date')->date()->placeholder('Weekly'),
