...
<x-waggies.cover-hero :hero="['eyebrow' => $page['eyebrow'], 'title' => $page['title'], 'description' => $page['hero']['description'], 'imageSrc' => $page['hero']['imageSrc'], 'imageAlt' => $page['hero']['imageAlt'], 'actions' => [['label' => $page['ctaText'], 'url' => route($page['ctaRoute'], $page['ctaParams'] ?? [])]]]" size="compact" />
