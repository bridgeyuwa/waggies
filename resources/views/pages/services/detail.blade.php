...
<x-waggies.cover-hero :hero="['eyebrow' => $page['eyebrow'], 'title' => $page['title'], 'description' => $page['hero']['description'], 'imageSrc' => $page['hero']['imageSrc'], 'imageAlt' => $page['hero']['imageAlt'], 'primaryAction' => ['label' => $page['ctaText'], 'route' => $page['ctaRoute'], 'params' => $page['ctaParams'] ?? []]]" size="compact" />
