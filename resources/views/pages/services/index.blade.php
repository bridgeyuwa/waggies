...
<section class="bg-surface py-20"><div class="mx-auto max-w-7xl px-4 md:px-10 lg:px-12"><div class="mb-14 text-center"><h2 class="text-h2 leading-tight text-primary-dark">Before You Book, Here&apos;s What You Should Know</h2><p class="mx-auto max-w-2xl text-primary-dark/60">Quick answers to help you choose the right service for your pet with confidence.</p></div><x-waggies.faq-accordion :faqs="$faqs" /></div></section>

<section class="w-full py-20"><div class="mx-auto max-w-7xl px-4 md:px-10 lg:px-12"><div class="w-full rounded-2xl bg-primary-dark"><div class="mx-auto flex max-w-5xl flex-col gap-10 px-4 py-12 md:flex-row md:items-center md:justify-between md:px-10 md:py-16 lg:px-12"><div class="flex max-w-xl flex-col items-center gap-5 text-center md:items-start md:text-left"><h2 class="font-serif text-3xl font-bold leading-tight text-white md:text-4xl">Book Your Pet&apos;s<br/><span class="text-secondary italic">Next Visit</span></h2><p class="max-w-sm text-base leading-relaxed text-white/65 md:max-w-md">Book a service or speak with our care team today.</p></div><div class="flex flex-wrap justify-center gap-3 md:items-center md:justify-end"><a href="{{ route('contact', ['intent' => 'booking']) }}" class="w-cta w-cta--primary !bg-secondary !text-primary-dark">Book a Service <x-waggies.icon name="arrow-forward" size="16" /></a><a href="tel:+2349080811902" class="w-cta w-cta--secondary border-white/30 bg-transparent text-white hover:bg-white/10"><x-waggies.icon name="phone" size="16" />Call Us Now</a></div></div></div></div></section>
