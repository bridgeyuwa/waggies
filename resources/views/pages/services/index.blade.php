...
<section class="bg-surface py-20"><div class="mx-auto max-w-7xl px-4 md:px-10 lg:px-12"><x-waggies.section-heading title="Before You Book, Here&apos;s What You Should Know" subtitle="Quick answers to help you choose the right service for your pet with confidence." spacing="mb-14" /><x-waggies.faq-accordion :faqs="$faqs" /></div></section>
