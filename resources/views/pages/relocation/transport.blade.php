...
<x-waggies.cover-hero :hero="array_merge($page['hero'], ['eyebrow' => 'Local Transport · Relocation', 'eyebrowIcon' => 'transport', 'title' => 'Local Transport', 'description' => 'Air-conditioned, purpose-fitted vehicles for pet pickup and drop-off anywhere across Abuja. Part of Waggies relocation services.', 'primaryAction' => ['label' => 'Request Transport', 'route' => 'contact', 'params' => ['intent' => 'transport', 'service' => 'local-transport']]])" />
<x-waggies.service-page-enhanced :page="$page" :faqs="$faqs" />
