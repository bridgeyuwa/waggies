{{--
    Hero — Image overlay (B7, Archetype 2).
    Full-bleed background image with gradient overlay. Used on all service pages.
...
<section class="relative flex flex-col justify-end bg-cover bg-center"
