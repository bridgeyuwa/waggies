...
@endphp
<div class="relative flex h-full flex-col rounded-2xl border {{ !empty($tier['featured']) ? 'border-2 border-primary shadow-soft' : 'border-surface-purple shadow-sm transition-shadow hover:shadow-soft' }} bg-white p-8">
