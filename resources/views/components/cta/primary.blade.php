...
@props([
    'badge_icon'      => null, //'star'
    'badge_text'      => null, //'Trusted by 2,000+ Pet Owners'
...
<div class="w-full bg-primary-dark overflow-hidden relative rounded-2xl">
    ...
    {{-- Container (matches A's structure) --}}
    <div class="max-w-7xl mx-auto px-4 md:px-10 lg:px-12 py-12 md:py-16 relative">

        {{-- Decorative blobs --}}
        <div class="absolute top-[-20%] right-[-5%] w-72 h-72 bg-primary/40 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute bottom-[-20%] left-[-5%] w-56 h-56 bg-secondary/15 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-10 max-w-5xl mx-auto">
            ...
            <div class="flex flex-col items-center md:items-start text-center md:text-left gap-5 max-w-xl">
                ...
                @if($badge_icon || $badge_text)
                    <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/20 bg-white/10
            ...
            <div class="flex flex-wrap md:flex-row gap-3 justify-center md:justify-end md:items-center">
                ...
                <a href="{{ $primary_href }}"
                   class="inline-flex items-center justify-center gap-2 bg-secondary hover:bg-secondary-hover text-primary-dark
                ...
                <a href="{{ $secondary_href }}"
                   class="inline-flex items-center justify-center gap-2 border border-white/30 text-white
                          px-8 py-3.5 rounded-full font-semibold hover:bg-white/10 transition-colors
                          focus:outline-none focus:ring-2 focus:ring-white/40">
                    <span class="material-symbols-outlined text-base">{{ $secondary_icon }}</span>
                    {{ $secondary_label }}
                </a>
