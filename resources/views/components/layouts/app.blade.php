...
<head>
    ...
    {{-- Schema.org: base Organisation on every page --}}
    @php
        echo \Spatie\SchemaOrg\Schema::organization()
        ->name('Waggies')
    ...
    echo \Spatie\SchemaOrg\Schema::localBusiness()
        ->name('Waggies')
        ->description("Luxury pet boarding, grooming, vet care, training, transport and relocation in Abuja, Nigeria.")
        ->url(url('/'))
        ->address(
