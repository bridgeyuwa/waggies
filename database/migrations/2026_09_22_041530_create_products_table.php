    ...
    public function up(): void
    {
        ...
        DB::table('products')->insert(array_map(
            static fn (array $product, int $index): array => [
                ...
                'image' => "/media/shop/{$product['id']}/hero.jpg",
